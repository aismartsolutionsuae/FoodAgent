...
// Register visible command menu (the 🎛 button in Telegram's text input).
// Call once on startup / deploy. In production, invoke via a separate script
// or add to a /api/setup endpoint. Here we call it lazily on first request.
